...
\begin{IEEEeqnarray*}{rCl}
	ROA = \frac{EBIT}{Act} = \underbrace{\frac{EBIT}{V}}_{Mar.Op.}\cdot\underbrace{\frac{V}{Act}}_{Rot.~de~Act.}
\end{IEEEeqnarray*}

\begin{IEEEeqnarray*}{rCl}
ROE = \frac{UN}{PN} = \frac{EBIT}{V}\cdot \underbrace{\frac{V}{Act}}_{Mar.Op.}\cdot\underbrace{\frac{Act}{PN}}_{Endeud.}\cdot \frac{EBT}{EBIT}\cdot \underbrace{\frac{UN}{EBT}}_{Apalanc.Fiscal}
\end{IEEEeqnarray*}
