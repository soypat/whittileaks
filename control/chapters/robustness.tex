...
\begin{figure}[htb!]
	...
	% BODE
		...
		\begin{semilogxaxis}[xlabel={Frecuencia $\omega$ [rad/s]}, ylabel={Amplitud [dB]},
		...
		\end{tikzpicture}
		\begin{tikzpicture}[trim axis right]
		\begin{semilogxaxis}[xlabel={Frecuencia $\omega$ [rad/s]}, ylabel={Angulo de desfasaje $\varphi$ [grados]},
