\contentsline {lstlisting}{\numberline {1.1}\texttt {node2dof} para \ensuremath {\vartheta _{\mathrm {nod.}}}=3. }{4}{lstlisting.1.1}%
\contentsline {lstlisting}{\numberline {1.2}Obtención de matriz elemdof.}{4}{lstlisting.1.2}%
\contentsline {lstlisting}{\numberline {1.3}Obtención generica de matriz de rigidez.}{4}{lstlisting.1.3}%
\contentsline {lstlisting}{\numberline {1.4}Aplicación de condiciones de borde esenciales.}{5}{lstlisting.1.4}%
\contentsline {lstlisting}{\numberline {1.5}Condiciones de borde naturales (cargas).}{5}{lstlisting.1.5}%
\contentsline {lstlisting}{\numberline {1.6}Resolución del sistema lineal.}{6}{lstlisting.1.6}%
\contentsline {lstlisting}{\numberline {1.7}Recuperación de desplazamientos globales.}{6}{lstlisting.1.7}%
